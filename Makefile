...
assignment_01/driver/gemm_driver: assignment_01/driver/driver.cpp assignment_01/src/gemm.cpp
	$(CXX) $(CXXFLAGS) assignment_01/driver/driver.cpp assignment_01/src/gemm.cpp -o assignment_01/driver/gemm_driver
