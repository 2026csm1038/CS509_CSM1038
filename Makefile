...
ASSIGNMENT_04_INC = -Icommon -Iassignment_04/src
...
assignment_04/driver/vertex_coloring_driver: \
	...
	$(CXX) $(CXXFLAGS) $(ASSIGNMENT_04_INC) \
	$(COMMON) \
	assignment_04/src/vertex_coloring.cpp \
	assignment_04/driver/vertex_coloring_driver.cpp \
	-o assignment_04/driver/vertex_coloring_driver
...
assignment_04/driver/pagerank_driver: \
	...
	assignment_04/src/pagerank.cpp \
	assignment_04/driver/pagerank_driver.cpp \
	-o assignment_04/driver/pagerank_driver
...
clean:
	...
	rm -f assignment_04/driver/vertex_coloring_driver
	rm -f assignment_04/driver/pagerank_driver
